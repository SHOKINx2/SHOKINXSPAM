...
HELP_BUTTON = [
    ...
    [
      Button.url("• ᴄʜᴀɴɴᴇʟ •", "https://t.me/THEKIDZWORLD"),
      Button.url("• sᴜᴘᴘᴏʀᴛ •", "https://t.me/THEKIDZWORLD")
    ]
  ]
    ...
    if event.sender_id in SUDO_USERS:
        try:
          await event.client.send_file(event.chat_id,
              "https://te.legra.ph/file/6e8c8adc9e3785c2862e0.jpg",
              caption=HELP_STRING,
              buttons=HELP_BUTTON
              )
...
async def helpback(event):
    if event.query.user_id in SUDO_USERS:    
        ...
        await event.answer("Make Your Own SHOKIN Bots !! @III_HEART_BREAKER_III", cache_time=0, alert=True)
